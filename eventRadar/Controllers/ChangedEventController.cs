...
namespace eventRadar.Controllers
{
    ...
    public class ChangedEventController : ControllerBase
    {
        ...
        public async Task<IEnumerable<ChangedEventDto>> GetMany()
        {
            ...
            return changedEvent.Select(o => new ChangedEventDto(o.Id, o.OldInformation, o.NewInformation, o.ChangeTime));
        }
        ...
        public async Task<ActionResult<ChangedEventDto>> Get(int changedEventId)
        {
            ...
            return new ChangedEventDto(changedEvent.Id, changedEvent.OldInformation, changedEvent.NewInformation, changedEvent.ChangeTime);
        }
        ...
        {
            var changedEvent = new ChangedEvent { OldInformation = createChangedEventDto.OldInformation, NewInformation = createChangedEventDto.NewInformation, ChangeTime = createChangedEventDto.ChangeTime };
            await _changedEventRepository.CreateAsync(changedEvent);

            return Created("", new ChangedEventDto(changedEvent.Id, changedEvent.OldInformation, changedEvent.NewInformation, changedEvent.ChangeTime));
        }
        ...
        public async Task<ActionResult<ChangedEventDto>> Update(int changedEventId, UpdateChangedEventDto updateChangedEventDto)
        {
            ...
            return Ok(new ChangedEventDto(changedEventId, changedEvent.OldInformation, changedEvent.NewInformation, changedEvent.ChangeTime));
        }
