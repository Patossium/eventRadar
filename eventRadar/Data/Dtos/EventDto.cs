...
{
    public record EventDto(int Id, string Url, string Title, string Date, string ImageLink, double Price, string TicketLink, bool Updated, Location Location, Category Category);
